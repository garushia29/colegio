<nav class="navbar navbar-expand-lg navbar-custom">
    <div class="container-fluid">
        ...
        <a class="navbar-brand" href="<?php echo URL; ?>public">Sistema de Gestión Escolar</a>
        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav">
            <span class="navbar-toggler-icon"></span>
        </button>
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item"><a class="nav-link active text-white" href="<?php echo URL; ?>public/usuarios">Usuarios</a></li>
            ...
            <div class="d-flex ms-auto">
                <a class="btn btn-success me-2" href="<?php echo URL; ?>public/cursos/create">Agregar Curso</a>
